...
function Draw-AppleTile([System.Drawing.Graphics]$g, [System.Drawing.RectangleF]$rect, [System.Drawing.Color]$topCol, [System.Drawing.Color]$botCol, [float]$radius = 28.0) {
    ...
    $shadowRect = New-Object System.Drawing.RectangleF($rect.X, $rect.Y + 4, $rect.Width, $rect.Height)
    ...
    $shineRect = New-Object System.Drawing.RectangleF($rect.X + 6, $rect.Y + 2, $rect.Width - 12, ($rect.Height / 2.2))
...
Draw-AppleTile $g (New-Object System.Drawing.RectangleF(0, 0, 144, 144)) ([System.Drawing.Color]::FromArgb(0x6E, 0x7B, 0xFA)) ([System.Drawing.Color]::FromArgb(0x3B, 0x46, 0xC4)) 0.01
...
Draw-AppleTile $g (New-Object System.Drawing.RectangleF(0, 0, 144, 144)) ([System.Drawing.Color]::FromArgb(0x2B, 0x2D, 0x31)) ([System.Drawing.Color]::FromArgb(0x15, 0x16, 0x18)) 0.01

# Neon Audio Halo
$haloBrush = New-Object System.Drawing.Drawing2D.PathGradientBrush((Create-RoundedRectPath (New-Object System.Drawing.RectangleF(36, 32, 72, 72)) 36))
...
# Mic Capsule
$micRect = New-Object System.Drawing.RectangleF(58, 32, 28, 44)
...
$g.DrawArc($standPen, (New-Object System.Drawing.RectangleF(49, 48, 46, 44)), 0, 180)
...
$redBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush((New-Object System.Drawing.RectangleF(34, 34, 76, 76)), [System.Drawing.Color]::FromArgb(0xFF, 0x5C, 0x5C), [System.Drawing.Color]::FromArgb(0xED, 0x42, 0x45), [System.Drawing.Drawing2D.LinearGradientMode]::ForwardDiagonal)
...
$coneBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush((New-Object System.Drawing.RectangleF(28, 44, 38, 56)), [System.Drawing.Color]::FromArgb(255, 255, 255), [System.Drawing.Color]::FromArgb(0x58, 0x65, 0xF2), [System.Drawing.Drawing2D.LinearGradientMode]::Vertical)
...
$g.DrawArc($wPen1, (New-Object System.Drawing.RectangleF(56, 56, 32, 32)), -50, 100)
$g.DrawArc($wPen2, (New-Object System.Drawing.RectangleF(66, 46, 52, 52)), -50, 100)
$g.DrawArc($wPen3, (New-Object System.Drawing.RectangleF(76, 36, 72, 72)), -50, 100)
...
$plusH = Create-RoundedRectPath (New-Object System.Drawing.RectangleF(48, 66, 48, 12)) 6
$plusV = Create-RoundedRectPath (New-Object System.Drawing.RectangleF(66, 48, 12, 48)) 6
$plusBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush((New-Object System.Drawing.RectangleF(48, 48, 48, 48)), [System.Drawing.Color]::FromArgb(255, 255, 255), [System.Drawing.Color]::FromArgb(0x57, 0xF2, 0x87), [System.Drawing.Drawing2D.LinearGradientMode]::Vertical)
...
$minusH = Create-RoundedRectPath (New-Object System.Drawing.RectangleF(48, 66, 48, 12)) 6
$minusBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush((New-Object System.Drawing.RectangleF(48, 66, 48, 12)), [System.Drawing.Color]::FromArgb(255, 255, 255), [System.Drawing.Color]::FromArgb(0x8E, 0xA0, 0xFF), [System.Drawing.Drawing2D.LinearGradientMode]::Vertical)
...
$arrBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush((New-Object System.Drawing.RectangleF(48, 46, 48, 52)), [System.Drawing.Color]::FromArgb(255, 255, 255), [System.Drawing.Color]::FromArgb(0xDB, 0xDE, 0xE1), [System.Drawing.Drawing2D.LinearGradientMode]::Vertical)
...
$body.AddArc((New-Object System.Drawing.RectangleF(42, 80, 60, 50)), 180, 180)
$body.CloseFigure()

$userBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush((New-Object System.Drawing.RectangleF(42, 40, 60, 60)), [System.Drawing.Color]::FromArgb(255, 255, 255), [System.Drawing.Color]::FromArgb(0x94, 0x9B, 0xA4), [System.Drawing.Drawing2D.LinearGradientMode]::Vertical)
...
$ringRect = New-Object System.Drawing.RectangleF(8, 8, 128, 128)

# Multi-layer Outer Glow
for ($i = 5; $i -ge 1; $i--) {
    $adj = $i * 1.5
    $gPath = Create-RoundedRectPath (New-Object System.Drawing.RectangleF($ringRect.X - $adj, $ringRect.Y - $adj, $ringRect.Width + ($adj*2), $ringRect.Height + ($adj*2))) (26 + $i)
...
$innerRect = New-Object System.Drawing.RectangleF($ringRect.X + 2.5, $ringRect.Y + 2.5, $ringRect.Width - 5, $ringRect.Height - 5)
